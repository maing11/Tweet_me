...
class EditProfileController: UITableViewController {
    ...
    private var imageChanged: Bool {
        ...
        {
//        When the image gets set - We gonna change the image in our profile header
        didSet {
...
//        configureImagePicker()
    ...
    @objc func handleDone() {
        ...
        // The done Button is only going to execute if one of these two things is true and then it's gonna update our user data
